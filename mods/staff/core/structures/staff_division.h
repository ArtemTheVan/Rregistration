...
typedef QList<StaffDivision> StaffDivisionList;
...
public:
    ...
    StaffDivisionList divisions() const;
    void setDivisions(const StaffDivisionList& divisions);
    ...
    StaffDivisionList getDivisions(staff::DivisionType type);
