...
Item {
    ...
    property alias pathModel: pathModelView.model
    property alias caption: hrText.text

    signal close();
    signal confirm();
    signal arrowUp();
    signal arrowDown();
    signal pathDelegateAction(int index, string name);
    signal itemChoosed();
    ...
    Item {
        ...
        Row {
            ...
            IconButton {
                ...
                onClicked: main.arrowDown(); //structurePage.children[0].incrementCurrentIndex();
            }
            ...
            IconButton {
                ...
                onClicked: main.arrowUp(); //structurePage.children[0].decrementCurrentIndex();
            }
        }
        // [/right]
        Line {
    ...
    Item {
        ...
        ListView {
            ...
            delegate: PathPanelDelegate {
                ...
                arrow: arrowRole
                onClicked: {
                    main.pathDelegateAction(itemIndex, text);
                }
    ...
    Item {
        ...
        ToolPanel {
            id: toolPanel
            x: container.width - toolPanel.width
            anchors {
                top: parent.top
                bottom: parent.bottom
            }

            onItemChoosed: main.itemChoosed();
        }
        // [/Tool panel]
        Item {
            id: body
