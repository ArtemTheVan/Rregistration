...
Rectangle {
    ...
    Item {
        ...
        MouseArea {
            ...
            onDoubleClicked: {
                if( type === 3 ) {
                    //staffPathModel.add(staffDelegate.name, staffDelegate.nameFull);
                    //staffStructModel.toChildDivision(staffDelegate.name);                    
                }
            }
